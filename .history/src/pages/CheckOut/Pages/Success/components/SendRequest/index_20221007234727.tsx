...
import { MetodosDePagamentoOpn } from "../../../../components/CompleteOrderForm/PaymenteMethodo";
      ...
      <ContainerLinear>
        ...
        <Container>
          ...
          <div>
            ...
            <span> <strong>{ MetodosDePagamentoOpn[state.MetodosDePagamentoOpn].label} </strong> </span>
          </div>
        </Container>
